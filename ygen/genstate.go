...
// buildStructDefinitions extracts the yang.Entry instances from a map of
...
func (s *genState) buildStructDefinitions(entries map[string]*yang.Entry, compressOCPaths, genFakeRoot bool) (map[string]*yangStruct, []error) {
	var errs []error
