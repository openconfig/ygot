...
// GetC1 retrieves the value of the C1 field of the
// receiver InputStruct. If the field is unset, the default value of the field
// is returned.
...
`,
		...
		wantCompressed: wantGoStructOut{
			structs: `
// Container represents the a/container YANG schema element.
type Container struct {
	BooleanWithDefault	*bool	` + "`" + `path:"container/boolean-with-default"` + "`" + `
	EmptyType	YANGEmpty	` + "`" + `path:"container/empty-type"` + "`" + `
	Int8WithDefault	*int8	` + "`" + `path:"container/int8-with-default"` + "`" + `
	Int8WithNoDefault	*int8	` + "`" + `path:"container/int8-with-no-default"` + "`" + `
	StringLeafList	[]string	` + "`" + `path:"container/string-leaf-list"` + "`" + `
	StringWithDefault	*string	` + "`" + `path:"container/string-with-default"` + "`" + `
	StringWithNoDefault	*string	` + "`" + `path:"container/string-with-no-default"` + "`" + `
}
...
`,
			methods: `
// GetBooleanWithDefault retrieves the value of the BooleanWithDefault field of the
// receiver Container. If the field is unset, the default value of the field
// is returned.
func (s *Container) GetBooleanWithDefault() *bool {
  if s.BooleanWithDefault == nil {
    return ygot.Bool(true)
  }
  return s.BooleanWithDefault
}

// GetEmptyType retrieves the value of the EmptyType field of the
// receiver Container. If the field is unset, the default value of the field
// is returned.
func (s *Container) GetEmptyType() YANGEmpty {
  return s.EmptyType
}

// GetInt8WithDefault retrieves the value of the Int8WithDefault field of the
// receiver Container. If the field is unset, the default value of the field
// is returned.
func (s *Container) GetInt8WithDefault() *int8 {
  if s.Int8WithDefault == nil {
    return ygot.Int8(42)
  }
  return s.Int8WithDefault
}

// GetInt8WithNoDefault retrieves the value of the Int8WithNoDefault field of the
// receiver Container. If the field is unset, the default value of the field
// is returned.
func (s *Container) GetInt8WithNoDefault() *int8 {
  return s.Int8WithNoDefault
}

// GetStringLeafList retrieves the value of the StringLeafList field of the
// receiver Container. If the field is unset, the default value of the field
// is returned.
func (s *Container) GetStringLeafList() []string {
  return s.StringLeafList
}

// GetStringWithDefault retrieves the value of the StringWithDefault field of the
// receiver Container. If the field is unset, the default value of the field
// is returned.
func (s *Container) GetStringWithDefault() *string {
  if s.StringWithDefault == nil {
    return ygot.String("default-value")
  }
  return s.StringWithDefault
}

// GetStringWithNoDefault retrieves the value of the StringWithNoDefault field of the
// receiver Container. If the field is unset, the default value of the field
// is returned.
func (s *Container) GetStringWithNoDefault() *string {
  return s.StringWithNoDefault
}

// Validate validates s against the YANG schema corresponding to its type.
func (s *Container) Validate(opts ...ygot.ValidationOption) error {
	if err := ytypes.Validate(SchemaTree["Container"], s, opts...); err != nil {
		return err
	}
	return nil
}
