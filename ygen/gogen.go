...
var (
	// packageImportPaths stores the default import paths that should be used
	// within the generated Go. It is keyed by a short name for a particular
	// import.
...
func writeGoHeader(yangFiles, includePaths []string, cfg GeneratorConfig) (string, error) {
	...
	if cfg.GoOptions.YgotImportPath == "" {
		cfg.GoOptions.YgotImportPath = packageImportPaths["ygot"]
	}
	if cfg.GoOptions.GoyangImportPath == "" {
		cfg.GoOptions.GoyangImportPath = packageImportPaths["goyang"]
	}
	if cfg.GoOptions.YtypesImportPath == "" {
		cfg.GoOptions.YtypesImportPath = packageImportPaths["ytypes"]
	}
