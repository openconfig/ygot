...
func writeGoHeader(yangFiles, includePaths []string, cfg GeneratorConfig) (string, error) {
	...
	if err := goTemplates["header"].Execute(&buf, buildCommonHeader(cfg.PackageName, cfg.Caller, cfg.CompressOCPaths, yangFiles, includePaths, cfg.GenerateJSONSchema)); err != nil {
		return "", err
	}
