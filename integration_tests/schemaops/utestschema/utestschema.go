...
// ordered map of the Ctestschema_OrderedMultikeyedLists struct. The keys of the list are
// populated from the input arguments.
func (s *Ctestschema_OrderedMultikeyedLists) AppendNewOrderedMultikeyedList(Key1 string, Key2 uint64) (*Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList, error) {
	if s.OrderedMultikeyedList == nil {
		s.OrderedMultikeyedList = &Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList_OrderedMap{}
	}
	return s.OrderedMultikeyedList.AppendNew(Key1, Key2)
}

// AppendOrderedMultikeyedList appends the supplied Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList struct
// to the list OrderedMultikeyedList of Ctestschema_OrderedMultikeyedLists. If the key value(s)
// specified in the supplied Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList already exist in the list, an
// error is returned.
func (s *Ctestschema_OrderedMultikeyedLists) AppendOrderedMultikeyedList(v *Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList) error {
	if s.OrderedMultikeyedList == nil {
		s.OrderedMultikeyedList = &Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList_OrderedMap{}
	}
...
// OrderedMultikeyedList map field of Ctestschema_OrderedMultikeyedLists. If the receiver
// is nil, or the specified key is not present in the list, nil is returned
// such that Get* methods may be safely chained.
func (s *Ctestschema_OrderedMultikeyedLists) GetOrderedMultikeyedList(Key1 string, Key2 uint64) *Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList {
...
// the receiver Ctestschema_OrderedMultikeyedLists. If there is no such element, the
// function is a no-op.
...
// Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList_OrderedMap is an ordered map that represents the "ordered-by user"
...
// IsYANGOrderedList ensures that Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList_OrderedMap implements the
// ygot.GoOrderedList interface.
...
func (o *Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList_OrderedMap) Append(v *Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList) error {
	if o == nil {
		return fmt.Errorf("nil ordered map, cannot append Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList")
	}
	if v == nil {
...
func (o *Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList_OrderedMap) AppendNew(Key1 string, Key2 uint64) (*Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList, error) {
	if o == nil {
		return nil, fmt.Errorf("nil ordered map, cannot append Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList")
	}
	key := Ctestschema_OrderedMultikeyedLists_OrderedMultikeyedList_Key{
		Key1: Key1,
		Key2: Key2,
