...
// 	protoc        v3.11.4
// source: github.com/openconfig/ygot/integration_tests/annotations/apb/annotation.proto
...
func file_github_com_openconfig_ygot_integration_tests_annotations_apb_annotation_proto_rawDescGZIP() []byte {
	file_github_com_openconfig_ygot_integration_tests_annotations_apb_annotation_proto_rawDescOnce.Do(func() {
		file_github_com_openconfig_ygot_integration_tests_annotations_apb_annotation_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_openconfig_ygot_integration_tests_annotations_apb_annotation_proto_rawDescData)
	})
