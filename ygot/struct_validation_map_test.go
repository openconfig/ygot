...
type mapStructTestOne struct {
	...
	OrderedList *testutil.OrderedMap   `path:"ordered-lists/ordered-list" module:"ctestschema/ctestschema"`
}
...
func TestEmitJSON(t *testing.T) {
	getOrderedMap := func() *testutil.OrderedMap {
		orderedMap := &testutil.OrderedMap{}
