...
func TestGeneratePathCode(t *testing.T) {
	tests := []struct {
		...
		name:                     "openconfig import with InputModulesOnly true",
		inFiles:                  []string{filepath.Join(datapath, "openconfig-import.yang")},
		inIncludePaths:           []string{datapath},
		wantStructsCodeFile:      filepath.Join(TestRoot, "testdata/structs/openconfig-import-only-input.path-txt"),
		inPreferOperationalState: true,
		inShortenEnumLeafNames:   true,
		inGenerateWildcardPaths:  true,
		inInputModulesOnly:       true,
		inSchemaStructPkgPath:    "",
		inPathStructSuffix:       "Path",
		checkYANGPath:            true,
		wantNodeDataMap: NodeDataMap{
		...
		name:                     "openconfig import with InputModulesOnly false",
		inFiles:                  []string{filepath.Join(datapath, "openconfig-import.yang")},
		inIncludePaths:           []string{datapath},
		...
		wantNodeDataMap: NodeDataMap{
			...
			"NativePath": {
				...
				GoFieldName:           "Native",
				SubsumingGoStructName: "Native",
				YANGPath:              "/openconfig-simple-target/native",
			},
			"Native_APath": {
				GoTypeName:            "string",
				LocalGoTypeName:       "string",
				...
				IsScalarField:         true,
				YANGTypeName:          "string",
				YANGPath:              "/openconfig-simple-target/native/state/a",
			},
			"TargetPath": {
				GoTypeName:            "*Target",
				LocalGoTypeName:       "*Target",
				GoFieldName:           "Target",
				SubsumingGoStructName: "Target",
				YANGPath:              "/openconfig-simple-target/target",
			},
		},
	}}
