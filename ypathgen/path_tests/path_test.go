...
import (
	...
	oc "github.com/openconfig/ygot/exampleocpath"
...
func TestPathCreation(t *testing.T) {
	tests := []struct {
		name     string
		makePath func(*oc.Root) ygot.PathStruct
		wantPath string
	}{{
		name: "simple",
		makePath: func(root *oc.Root) ygot.PathStruct {
			return root.Stp()
		},
		wantPath: "/stp",
	}, {
...
func TestWildcardPathCreation(t *testing.T) {
	tests := []struct {
		...
		makePath        func(*oc.Root) ygot.PathStruct
		wantPath        string
		makeWildPath    func(*oc.Root) ygot.PathStruct
		wantWildPath    string
		...
		makeWildPath: func(root *oc.Root) ygot.PathStruct {
