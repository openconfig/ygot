...
import (
	...
	pb "github.com/openconfig/yang_protobuf/protoc-gen-yanggo/yang/pkg/testproto"
)
...
func toDescriptorProto(msg *pb.AMessage) (*descriptor.FileDescriptorProto, error) {
...
// the original proto.
func descriptorProtoField(msg *pb.AMessage, field int) (*descriptor.FieldDescriptorProto, error) {
...
func TestBuildMap(t *testing.T) {
	...
	data, err := ioutil.ReadFile(filepath.Join("testdata", "request.textproto"))
	if err != nil {
