...
//go:generate go run ${SRCDIR}/generator/generator.go -path=yang -output_file=pkg/demo/uncompressed.go -package_name=demo -generate_fakeroot -fakeroot_name=root yang/example.yang
