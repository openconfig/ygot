...
//go:generate sh -c "go run ../../generator/generator.go -path=yang -output_dir=pkg/demo -package_name=demo -generate_fakeroot -fakeroot_name=root yang/example.yang && goimports -w pkg/demo/*.go"
