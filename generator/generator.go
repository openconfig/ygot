...
var (
	...
	// TODO(wenbli): Some invalid shadow paths currently do not cause an error during JSON unmarshalling. Specifically, they're paths more than 1 level deep below their config/state containers.
